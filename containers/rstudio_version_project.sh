...
SIF="$HOME/mountDuboule/UPDUB COMMON/Sif_Images/verse_with_more_packages_${sif_version}.sif"
...
1. SSH tunnel from your workstation using the following command:
   ...
   ssh -N -f -L 8787:$(hostname -i):${PORT} ${APPTAINERENV_USER}@galaxyduboule.epfl.ch
